...
<center>
<h2 style="background-color: #CCFF00;"><b> <i>BLOOD-BANK TABLE MANIPUTATE <i></b></h2>
<form name="form1" action="" method="post">
		<div class="input-group">
				...
				<td><input type="text" name="t6"></td><br><br>
					<td>BANK PINCODE</td>
				<td><input type="text" name="t7"></td><br><br>
					<td>BANK BLOOD GR.</td>
...
<option value="BBG">BOMBAY BLOOD GR</option>
				...
				{
					mysqli_query($link,"insert into bloodbank values('$_POST[t1]','$_POST[t2]','$_POST[t3]','$_POST[t4]','$_POST[t5]','$_POST[t6]','$_POST[t7]','$_POST[t8]')");
				}
				if(isset($_POST["submit2"]))
				{
					mysqli_query($link,"delete from bloodbank where donor_name='$_POST[t2]'");
				}
				if(isset($_POST["submit3"]))
				{
					mysqli_query($link,"update bloodbank set bloodbank_name= '$_POST[t2]' , bloodbank_address='$_POST[t3]' , phone='$_POST[t4]' , altrphone='$_POST[t5]' ,email= '$_POST[t6]' , pincode='$_POST[t7]' , bl='$_POST[t8]' where bloodbank_id='$_POST[t1]'");
				}
				if(isset($_POST["submit4"]))
				{
					...
					echo "<table >";
					echo "<tr>";
						echo "<th>"; echo "BANK-ID"; echo "</th>";
						echo "<th>"; echo "BANK-NAME"; echo "</th>";
						echo "<th>"; echo "BANK-ADDRESS"; echo "</th>";
					...
					{
						echo "<tr>";
						echo "<td>"; echo $row["bloodbank_id"]; echo "</td>";
						echo "<td>"; echo $row["bloodbank_name"]; echo "</td>";
						echo "<td>"; echo $row["bloodbank_address"]; echo "</td>";
				...
				{
					$res=mysqli_query($link,"select * from bloodbank where bloodbank_name='$_POST[t2]'");
					echo "<table border=1>";
					echo "<tr>";
						echo "<th>"; echo "bloodbank_id"; echo "</th>";
						echo "<th>"; echo "bloodbank_name"; echo "</th>";
						echo "<th>"; echo "bloodbank_address"; echo "</th>";
						echo "<th>"; echo "phone"; echo "</th>";
...
<div class="footer">
  <a href="" style="float: center;color:	#FFFF00;font-family: Courier New;font-variant: small-caps;font-size: 20px;float: left;background-color: #E9967A;">&copy;A PROTOTYPE WEBSITE FOR NIIT PROJECT</a>
  <a href="" style="float: right; color:	#FFFF00;font-family: Courier New;font-variant: small-caps;font-size: 20px;float: right;background-color: #E9967A;">&copy;DESIGN BY AVICK,ARITRA,SUBRATA,SOURADEEP</a>
</div>
