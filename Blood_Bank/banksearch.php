...
<center><h3 style="background: linear-gradient(to right, #ccffff 46%, #66ccff 100%); "> <b>Search For Blood Banks Details..................</b> 
</h3></center>
...
<?php
      if(isset($_POST['btn_search']))
	  {
		  $key1=$_POST["start"];
		  $key2=$_POST["end"];
		  $sql="select * from bloodbank where bl like '%$key1%' and pincode like '%$key2%'";
...
<table id="myTable">
			 <tr class="header">
			  <td style="width:20%;"><?php echo $row['bloodbank_name']?></td>
			   <td style="width:20%;"><?php echo $row['bloodbank_address']?></td>
